...
logger = logging.getLogger('firewall_1')
...
class Firewall_1(app_manager.RyuApp):
    ...
    def Configure_stateful_FW(self, msg):
        ...
        # Forward packets from inside to outside and also install the reverse rule with idle_to=11 sec
            ...
            self.add_flow(datapath, 10, match, actions, 11, 0)
            ...
            actions = []
            self.add_flow(datapath, 5, match, actions, 11, 0)

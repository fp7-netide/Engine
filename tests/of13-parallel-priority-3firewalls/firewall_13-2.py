...
logger = logging.getLogger('firewall_2')
...
class Firewall_2(app_manager.RyuApp):
    ...
    def Configure_stateful_FW(self, msg):
        ...
        # Forward packets from inside to outside and also install the reverse rule with idle_to=12 sec
            ...
            self.add_flow(datapath, 10, match, actions, 12, 0)
            ...
            actions = []
            self.add_flow(datapath, 5, match, actions, 12, 0)
